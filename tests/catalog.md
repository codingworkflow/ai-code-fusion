...
QA matrix screenshot artifact contract (baseline-ready):

- Linux screenshot artifact: `ui-screenshot-linux`
...
- Renderer flow changes:
  ...
  - `tests/unit/components/app-source-tab-activity.test.tsx`
