...
describe('Binary File Detection', () => {
  ...
  const mockFileContent = (content) => {
    ...
    fs.readSync.mockImplementation((fd, buf, offset, length, _position) => {
  ...
  test('should handle binary files with text headers', () => {
    ...
    const header = Buffer.from('SVG-XML-Header Version 1.0 - This looks like text but the file is actually binary content after this header');
